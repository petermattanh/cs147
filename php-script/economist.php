<?php
	...
	// $economist = new EconomistScraper('http://www.economist.com/world/china');
	// $economist = new EconomistScraper('http://www.economist.com/world/middle-east-africa');
	// $economist = new EconomistScraper('http://www.economist.com/business-finance');
	// $economist = new EconomistScraper('http://www.economist.com/economics');
	// $economist = new EconomistScraper('http://www.economist.com/science-technology');
	...
	class EconomistScraper {
		...
		private function getArticleUrls($url) {
			...
			foreach($articleList as $article) {
				...
				$spanLength  = strlen($articleTag->getElementsByTagName('span')->item(0)->nodeValue);
		...
		private function getArticleContent($link) {
